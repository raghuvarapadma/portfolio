    ...
    <div className={`transition-all duration-500 ease-out ${isVisible ? 'h-full opacity-100' : 'h-0 opacity-0'}`}>
      ...
      <div className="flex flex-row">
        <div className="flex-1 flex flex-col items-left justify-center">
          <div className="my-3">
            <div className="font-code text-3xl" >
              <div className="inline-flex flex-nowrap hover:text-[#097969]" onMouseEnter={() => setNameText(true)} onMouseLeave={() => setNameText(false)}>
                {nameText}
              </div>
            </div>
          ...
          <div className="my-3 flex flex-col gap-2">
            <div className="flex flex-row justify-left gap-3">
              <a href="mailto:raghuvarapadma@gmail.com">
        ...
        <div className="flex items-center justify-center">
          <div className="w-32 h-32 sm:w-64 sm:h-64 rounded-full overflow-hidden">
      ...
      <div className="flex flex-col my-6">
        ...
        <div className="whitespace-pre-line">
          ...
          <br />
          One of my goals this year is to be better about meeting new people. Whether you want to talk about software engineering, say hi, or discuss anything else, feel free to reach out to me. The best way to get in touch is through email at raghuvarapadma [@] gmail.com.<br />
        </div>
      </div>
      <div className="border-t-2 border-[#097969] my-6"></div>
      <div className="flex flex-col my-6">
